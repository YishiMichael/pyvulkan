...
## defines
def VK_MAKE_VIDEO_STD_VERSION(major: int, minor: int, patch: int) -> int: return (major << 22) | (minor << 12) | patch
...
def VK_MAKE_VERSION(major: int, minor: int, patch: int) -> int: return (major << 22) | (minor << 12) | patch
def VK_VERSION_MAJOR(version: int) -> int: return version >> 22
def VK_VERSION_MINOR(version: int) -> int: return (version >> 12) & 0x3FF
def VK_VERSION_PATCH(version: int) -> int: return version & 0xFFF
def VK_MAKE_API_VERSION(variant: int, major: int, minor: int, patch: int) -> int: return (variant << 29) | (major << 22) | (minor << 12) | patch
def VK_API_VERSION_VARIANT(version: int) -> int: return version >> 29
def VK_API_VERSION_MAJOR(version: int) -> int: return (version >> 22) & 0x7F
def VK_API_VERSION_MINOR(version: int) -> int: return (version >> 12) & 0x3FF
def VK_API_VERSION_PATCH(version: int) -> int: return version & 0xFFF
VKSC_API_VARIANT = 1
